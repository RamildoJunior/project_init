package br.com.order.validation;
...
public class GlobalHandler {
    ...
    public ResponseEntity<Object> exceptionResultDataAccess(EmptyResultDataAccessException exception) {
        return new ResponseEntity<>(new ExceptionResponse(HttpStatus.NOT_FOUND.value(), "Could not find!"),
    ...
    public ResponseEntity<Object> exceptionEntityNotFound(EntityNotFoundException exception) {
        return new ResponseEntity<>(new ExceptionResponse(HttpStatus.NOT_FOUND.value(), "Unable to find!"),
                HttpStatus.NOT_FOUND);
    }
